...
# Id Dicoding   : dicoding.com/users/ridwanrahmat/              =
# Github Pages  : https://github.com/ridwanrahmat                      =
# Created       : 26 Februari 2024                              =
...
@st.cache_resource
def load_data():
    data = pd.read_csv("https://raw.githubusercontent.com/ridwanrahmat/project_analisis_data_dicoding/main/Dataset/hour.csv")
    return data
...
st.sidebar.markdown("**• Name: Ridwan Rahmat**")
st.sidebar.markdown(
    "**• Email: [lapaknyaridwan@gmail.com](lapaknyaridwan@gmail.com)**")
st.sidebar.markdown(
    "**• Dicoding: [ridwanrahmat](https://www.dicoding.com/users/ridwanrahmat/)**")
st.sidebar.markdown(
    "**• LinkedIn: [Ridwan Rahmat](https://www.linkedin.com/in/ridwanrahmat/)**")
st.sidebar.markdown(
    "**• Github: [ridwanrahmat](https://github.com/ridwanrahmat)**")
...
st.write("Copyright © 2024 Ridwan Rahmat. All rights reserved.")
